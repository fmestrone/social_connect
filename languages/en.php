...
$localized = array(
    ...
    'social_connect:settings:debug_mode_explain' => 'We recommend to set <b>debug mode</b> to <b style="color:green">YES</b> until you are sure you want to go live.',
    'social_connect:settings:debug_file' => 'Log File',
    'social_connect:settings:debug_file_explain' => 'Defaults to <i>log/debug.log</i>',
    'social_connect:settings:debug_level' => 'Log Level',
    'social_connect:settings:global_hook_default' => '<em>social_connect,user</em> hook',
    'social_connect:settings:global_hook_explain' => 'You can override this for each provider',
	'social_connect:settings:yes' => 'YES',
	'social_connect:settings:no' => 'NO',
	'social_connect:settings:privacy' => 'URL of Privacy Page',
	'social_connect:settings:privacy_explain' => '(leave it blank if you don\'t have one)',
    ...
    'social_connect:settings:hook_default' => 'Default <em>social_connect,user</em> hook response?',
